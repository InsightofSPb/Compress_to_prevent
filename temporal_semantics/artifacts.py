...
def list_available_backends() -> List[Dict[str, object]]:
    reg = default_registry()
    return reg.capability_table()
...
def export_semantic_artifacts(
    ...
    for sample in manifest:
        ...
        for backend_name in backends:
            ...
            caps = registry.capabilities(backend_name)
            ...
            rows.append(
                {
                    ...
                    "split": split,
                    "status": status,
                    "capabilities_json": json.dumps(caps.to_dict()),
